...
// ParticleText —— faithful ReactBits port (TypeScript + CSS). No third-party CSS import;
// styles live in globals.css. Particles converge into the text and drift; pointer repels them.
